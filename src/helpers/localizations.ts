export const localizations = {
  ...
  deleteEntryOnKick_true: {
    en:
      'Great! Sesuritu will remove entry messages of the users who failed captcha.',
    ru:
      'Sesuritu будет удалять сообщения о входе пользователей, проваливших капчу.',
    uk:
      'Чудово! Шилді тепер видалятиме усі вхідні повідомлення від користувачів, які провалили капчу.',
    tr:
      'Harika! Sesuritu, CAPTCHA testinden başarısız olan kullanıcıların giriş mesajlarını kaldıracak.',
    es:
      'Perfecto, Sesuritu eliminará los mensajes de los recién llegados que no hayan superado el CAPTCHA.',
    zh: '很棒！Sesuritu将删除验证码失败用户的加入消息。',
    de:
      'Top! Sesuritu wird nun die Beitrittsnachrichten entfernen, wenn ein User den Captcha Test nicht besteht.',
    sk:
      'Super! Sesuritu odstráni správy o vstupe nováčikov do četu, ak neprejdú testom captcha.',
    ja:
      '素晴らしいです！Sesurituは、キャプチャを失敗したユーザーの入室時のメッセージを削除します。',
    ro:
      'Minunat! Sesuritu va șterge fiecare mesaj al utilizatorilor ce nu au trecut testul captcha.',
    ca:
      "Entesos, a partir d'ara en Sesuritu esborrarà tots els missatges dels nouvinguts que no hagin superat la prova.",
    br:
      'Boa! Sesuritu removerá mensagens de entrada dos usuários que erraram o captcha.',
    he: 'מעולה! Sesuritu ימחק הודעות כניסה של משתמשים שנכשלו במבחן.',
    no:
      'Supert! Sesuritu vil fjerne inngangsmeldingene til brukere som ikke består captcha-testen.',
    yue: '好。由而家開始，Sesuritu 會自動刪除驗證失敗用戶嘅入羣訊息。',
    hu:
      'Nagyszerű! A Sesuritu eltávolítja a belépési üzenetet, ha a felhasználó elbukik a teszten.',
    fr:
      "Super! Sesuritu va supprimer les messages d'accueil des utilisateurs qui ont échoué au captcha.",
    bg:
      'Чудесно! Sesuritu ще премахне съобщенията за влизане на потребителите, които НЕ са отговорили на captcha. ',
  },
  deleteEntryOnKick_false: {
    en:
      'Great! Sesuritu will not remove entry messages of the users who failed captcha.',
    ru:
      'Великолепно! Sesuritu не будет удалять сообщения о входе пользователей, проваливших капчу.',
    uk:
      'Чудово. Шилді не буде видаляти вхідні повідомлення від користувачів, які провалили капчу.',
    tr:
      'Harika! Sesuritu, CAPTCHA testinden başarısız olan kullanıcıların giriş mesajlarını kaldırmayacak.',
    es:
      'Perfecto, Sesuritu no eliminará los mensajes de los recién llegados que no hayan superado el CAPTCHA.',
    zh: '很棒！Sesuritu将不会删除验证码失败用户的加入消息。',
    de:
      'Hammer! Sesuritu wird nun die Beitrittsnachrichten nicht entfernen, wenn ein User den Captcha Test nicht besteht.',
    sk:
      'Super! Sesuritu neodstráni správy o vstupe nováčikov do četu, ak neprejdú testom captcha.',
    ja:
      '素晴らしいです！Sesurituは、キャプチャを失敗したユーザーの入室時のメッセージを削除しません。',
    ro:
      'Minunat! Sesuritu nu va șterge fiecare mesaj al utilizatorilor ce nu au trecut testul captcha.',
    ca:
      "Entesos, a partir d'ara en Sesuritu no esborrarà tots els missatges dels nouvinguts que no hagin superat la prova.",
    br:
      'Boa! Sesuritu não removerá mensagens de entrada dos usuários que erraram o captcha.',
    he: 'מעולה! Sesuritu לא ימחק הודעות כניסה של מתמשים שנכשלנו במבחן.',
    no:
      'Supert! Sesuritu vil ikke fjerne inngangsmeldingene til brukere som ikke består captcha-testen.',
    yue: '好。由而家開始，Sesuritu 唔會自動刪除驗證失敗用戶嘅入羣訊息。',
    hu:
      'Nagyszerű! A Sesuritu nem távolítja el a belépési üzenetet, ha a felhasználó elbukik a teszten.',
    fr:
      "C'est noté! Sesuritu ne va plus supprimer les messages d'accueil des utilisateurs qui ont échoué au captcha.",
    bg:
      'Чудесно! Sesuritu няма да премахва съобщения за влизане на потребители, които НЕ са успели с captcha. ',
  },
  cas_true: {
    en: 'Great! Sesuritu will now use Combot Anti-Spam.',
    ru: 'Великолепно! Sesuritu теперь будет использовать Combot Anti-Spam.',
    uk: 'Чудово! Шилді тепер використовує Combot Anti-Spam.',
    tr: 'Harika! Sesuritu, artık Combot Anti-Spam kullanacak.',
    es:
      '¡Entendido! Ahora Sesuritu utilizará Combot Anti-Spam para combatir el spam.',
    sk: 'Skvelé! Sesuritu odteraz bude používať Combot Anti-Spam.',
    ca:
      "Molt bé, a partir d'ara en Sesuritu ferà servir Combot Anti-Spam per a combatre els missatges brossa.",
    br: 'Boa! Sesuritu agora usará o Combot Anti-Spam.',
    he: 'מעולה! Sesuritu מעכשיו ישתמש ב-Combot Anti-Spam.',
    no: 'Supert! Sesuritu vil nå bruke Combot Anti-Spam.',
    yue: '好。由而家開始，Sesuritu 會使用 Combot 提供嘅防滋擾功能。',
    hu: 'Nagyszerű! A Sesuritu ezentúl használja a Combot Anti-Spam megoldást.',
    fr: 'Super! Sesuritu va maintenant utiliser Combot Anti-Spam.',
    bg: 'Страхотно! Sesuritu вече ще използва Combot Anti-Spam. ',
  },
  cas_false: {
    en: 'Great! Sesuritu will not use Combot Anti-Spam now.',
    ru: 'Великолепно! Sesuritu теперь не будет использовать Combot Anti-Spam.',
    uk: 'Чудово! Шилді тепер не використовує Combot Anti-Spam.',
    tr: 'Harika! Sesuritu, artık Combot Anti-Spam kullanmayacak.',
    es:
      '¡Entendido! Ahora Sesuritu no utilizará Combot Anti-Spam para combatir el spam.',
    sk: 'Skvelé! Sesuritu odteraz nebude používať Combot Anti-Spam.',
    ca:
      "Molt bé, a partir d'ara en Sesuritu no ferà servir Combot Anti-Spam per a combatre els missatges brossa.",
    br: 'Boa! Sesuritu não usará o Combot Anti-Spam agora.',
    he: 'מעולה! Sesuritu מעכשיו לא ישתמש ב-Combot Anti-Spam.',
    no: 'Supert! Sesuritu vil nå ikke bruke Combot Anti-Spam.',
    yue: '好。由而家開始，Sesuritu 會停用 Combot 提供嘅防滋擾功能。',
    hu:
      'Nagyszerű! A Sesuritu ezentúl nemhasználja a Combot Anti-Spam megoldást.',
    fr: "Ok! Sesuritu n'utilisera pas Combot Anti-Spam.",
    bg: 'Страхотно! Sesuritu няма да използва Combot Anti-Spam сега. ',
  },
  underAttack_true: {
    en:
      "Great! Sesuritu will now kick everybody who enters this chat. Don't forget to turn this mode off when attack is over with /underAttack.",
    ru:
      'Отлично! Sesuritu теперь будет кикать всех, кто заходит в этот чат. Не забудьте отключить этот режим после окончания атаки при помощи команды /underAttack.',
    uk:
    ...
    es:
      '¡Entendido! Ahora Sesuritu expulsará a todo aquel que entre en este chat. No olvides desactivar este modo cuando el ataque haya cesado, para ello utiliza el comando /underAttack.',
    ca:
      "Molt bé, a partir d'ara en Sesuritu expulsarà a tothom que vulgui entrar en aquest xat. Procura desactivar aquest mode quan l'atac s'hagi esveït; per això fes servir la comanda /underAttack.",
    br:
      'Boa! Sesuritu vai kickar todos que entram neste bate-papo. Não se esqueça de desligar este modo quando o ataque acabar com /underAttack.',
    he:
      'מעולה! Sesuritu מעכשיו ירחיק את כל מי שיכנס לשיחוח. לא לשכוח לבטל את המצב כשההתקפה נגמרת בעזרת /underAttack.',
    no:
      'Supert! Sesuritu vil nå sparke alle som blir med i chatten. Ikke glem å slå av denne modusen når angrepet er over med /underAttack.',
    yue:
      '由而家開始，Sesuritu 會踢除所有嘗試入羣嘅人。等滋擾攻擊結束後，記得用 /underAttack 停用當前模式。',
    hu:
      'Nagyszerű! A Sesuritu mostantól minden új csatlakozót kivág a csatornáról. Ne felejtsd el kikapcsolni ezt a beállítást, amikor a támadás véget ár a /underAttack paranccsal.',
    fr:
      "Ok! Sesuritu va maintenant expulser tous ceux qui entreront dans ce groupe. N'oubliez pas de désactiver ce mode lorsque l'attaque est terminée via la commande /underAttack.",
    bg:
      'Чудесно! Sesuritu ще изхвърля всички, които влязат в тази група. Не забравяйте да изключите този режим, когато атаката приключи с /underAttack.',
  },
  underAttack_false: {
    en: 'Great! Sesuritu will not kick everybody who enters this chat.',
    ru: 'Отлично! Sesuritu теперь не будет кикать всех, кто заходит в этот чат.',
    uk:
      'Чудово! Шилді тепер не буде видаляти усіх, хто спробує увійти до чату.',
    es:
      '¡Entendido! Ahora Sesuritu ya no continuará expulsando a nadie que entre en este chat.',
    ca:
      "Molt bé, a partir d'ara en Sesuritu ja no continuarà expulsant a ningú que vulgui entrar en aquest xat",
    br: 'Boa! Sesuritu não vai kickar todos que entram neste bate-papo.',
    he: 'מעולה! Sesuritu לא ירחיק את כל מי שנכנס לשיחוח.',
    no: 'Supert! Sesuritu vil ikke sparke alle som blir med i chatten.',
    yue: '好。Sesuritu 而家唔會再踢除所有嘗試入 group 嘅人。',
    hu:
      'Nagyszerű! A Sesuritu mostantól nem vágja ki az új csatlakozókat a csatornáról.',
    fr: "Ok! Sesuritu n'expulsera plus tous ceux qui entrent dans ce groupe.",
    bg: 'Чудесно! Sesuritu няма да изхвърля никой, влизащите в тази група. ',
  },
  noAttack_true: {
    en:
      "Great! Sesuritu is disabled now. Don't forget to turn this mode off with /noAttack.",
    es:
      '¡Entendido! Ahora Sesuritu está desactivado. No olvides desactivar este modo usando /noAttack.',
    ca:
      "Molt bé, a partir d'ara en Sesuritu està desactivat i ja no vigilarà aquest xat. Per desactivar aquest mode fes servir la comanda /noAttack.",
    br:
      'Boa! Sesuritu está desativado agora. Não se esqueça de desativar esse modo com /noAttack.',
    he: 'מעולה! Sesuritu מכובה כעת. אל תשכחו לבטל את הפעולה בעזרת /noAttack.',
    no:
      'Supert! Nå er Sesuritu deaktivert. Ikke glem å slå av denne modusen med /noAttack.',
    yue:
      'Sesuritu 經已畀停用。要重新使用 Sesuritu，請用 /noAttack 停用當前模式。',
    ru:
      'Отлично! Sesuritu отключён. Не забудьте снова включить его командой /noAttack.',
    hu:
      'Nagyszerű! A Sesuritu letiltva. ne felejtsd el kikapcsolni ezt a módot a /noAttack paranccsal.',
    fr:
      "Super! Sesuritu est maintenant désactivé. N'oubliez pas de désactiver ce mode via la commande /noAttack.",
    bg:
      'Страхотно! Sesuritu в момента е деактивиран! Не забравяйте да изключите този режим с /noAttack.',
  },
  noAttack_false: {
    en: 'Great! Sesuritu is now on.',
    es: '¡Entendido! Ahora Sesuritu está activo.',
    ca: "Molt bé, a partir d'ara en Sesuritu està actiu i vigilant aquest xat.",
    br: 'Boa! Sesuritu está ativado agora.',
    he: 'מעולה! Sesuritu דלוק כעת.',
    no: 'Supert! Sesuritu er nå aktivert.',
    ru: 'Отлично! Sesuritu включён.',
    yue: ' 正！Sesuritu 已經開咗。',
    hu: 'Nagyszerű! a Shieldly újra engedélyezve van.',
    fr: 'Super! Sesuritu est maintenant activé!',
    bg: 'Чудесно! Sesuritu вече е включен.',
  },
  noChannelLinks_true: {
    en:
      'Great! Sesuritu will now delete messages that link to telegram channels.',
    ru:
      'Отлично! Sesuritu теперь будет удалять сообщения с ссылками на Телеграм-каналы.',
    es:
      '¡Genial! Ahora Sesuritu eliminará todos los mensajes que contengan enlaces a otros canales de Telegram.',
    ca:
      "D'acord, a partir d'ara en Sesuritu esborrarà tots el missatges que contenguin enllaços a altres canals de Telegram.",
    br:
      'Boa! Agora, o Sesuritu excluirá as mensagens vinculadas aos canais do telegram.',
    he: 'מעולה! מעכשיו Sesuritu ימחק הודעות עם קישור לערוץ טלגרם.',
    no:
      'Supert! Sesuritu vil nå slette meldinger som lenker til andre Telegram-kanaler.',
    yue:
      '好。由而家開始，Sesuritu 會自動刪除所有連結到其它 Telegram 頻道嘅訊息。',
    hu:
      'Nagyszerű! A Sesuritu mostantól törli az összes olyan linket, ami másik telegram csatornára hivatkozik.',
    fr:
      'Super! Sesuritu va maintenant supprimer les messages qui renvoient vers des autres groupes telegram. ',
    bg:
      'Чудесно! Sesuritu  ще изтрие съобщения, които водят към Telegram групи и канали. ',
  },
  noChannelLinks_false: {
    en:
      'Great! Sesuritu will not delete messages that link to telegram channels.',
    ru:
      'Отлично! Sesuritu теперь не будет удалять сообщения с ссылками на Телеграм-каналы.',
    es:
      '¡Genial! Ahora Sesuritu no eliminará ningún mensaje que contenga enlaces a otros canales de Telegram.',
    ca:
      "D'acord, a partir d'ara en Sesuritu ja no esborrarà cap missatge que contengui enllaços a altres canals de Telegram.",
    br:
      'Boa! O Sesuritu não excluirá as mensagens vinculadas aos canais do telegram.',
    he: 'מעולה! Sesuritu לא ימחק הודעות עם קישור לערוצים בטלגרם.',
    no:
      'Supert! Sesuritu vil ikke slette meldinger som lenker til andre Telegram-kanaler.',
    yue: '好。Sesuritu 而家唔會自動刪除所有連結到其它 Telegram 頻道嘅訊息。',
    hu:
      'Nagyszerű! A Sesuritu mostantól nem törli az olyan linket, ami másik telegram csatornára hivatkozik.',
    fr:
      "C'est noté! Sesuritu ne supprimera plus les messages qui partagerons des liens vers des groupes telegram.",
    bg:
      'Чудесно! Sesuritu няма да изтрива съобщения, които водят към Telegram групи и канали. ',
  },
  viewConfig: {
    en: 'Current config:',
  ...
  banForFastRepliesToPosts_true: {
    en:
      "Nice! Sesuritu will ban (or kick) all users who reply to your channel's posts 5 seconds after the post is created.",
    ru:
      'Отлично! Sesuritu будет банить (или кикать) пользователей, которые отвечают на посты вашего канала в течение 5 секунд после создания постов.',
    bg:
      'Яко! Sesuritu, ще забрани (или ще "изрита") всеки потребител, които отговорят на публикациите в канала ви 5 секунди след създаването на публикацията.',
  },
  banForFastRepliesToPosts_false: {
    en:
      "Nice! Sesuritu will not ban (or kick) all users who reply to your channel's posts 5 seconds after the post is created.",
    ru:
      'Отлично! Sesuritu не будет банить (или кикать) пользователей, которые отвечают на посты вашего канала в течение 5 секунд после создания постов.',
    bg:
      'Яко! Sesuritu няма да забранява (или да "изрита") никой потребител, които отговарят на публикациите на канала ви 5 секунди след създаването на публикацията.',
  },
  banNewTelegramUsers_true: {
    en:
      'Nice! Sesuritu will ban (or kick) all newcomers with Telegram ID greater than 1 000 000 000.',
    ru:
      'Отлично! Sesuritu будет банить (или кикать) пользователей, у которых Телеграм ID больше 1 000 000 000.',
    bg:
      'Чудесно! Sesuritu, ще забрани (или ще "изрита") всички новодошли с идентификатор на Telegram над 1 000 000 000. ',
  },
  banNewTelegramUsers_false: {
    ru:
      'Отлично! Sesuritu не будет банить (или кикать) пользователей, у которых Телеграм ID больше 1 000 000 000.',
    en:
      'Nice! Sesuritu will no ban (or kick) all newcomers with Telegram ID greater than 1 000 000 000.',
    bg:
      'Чудесно! Sesuritu няма да забранява (или да "изрита") никой новодошъл с Telegram ID над 1 000 000 000.',
  },
}
